...
<script>
    ...
    window.updateUserDataUrl = "{!! route('manager.update.data') !!}";
    window.updateUserPasswordUrl = "{!! route('manager.update.password') !!}";
    window.user = @json($user);
</script>
<script src="{{ mix('js/manager/home.js') }}"></script>
...
@section('content')
<div class="manager-home-container" id="manager-home">
    <div class="container-fluid">
        <div class="row ">
