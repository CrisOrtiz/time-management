...
var vueUsers = new Vue({
  ...
  methods: {
    viewTasks(user){
     window.location = '/worker/'+ user.id + '/tasks'
    },
    onChangeNameSort() {
      ...
      api
        .post(window.getSortedNameUsersUrl, {
          sort: this.namesort,
        })
        .then(
          (response) => {
    ...
    onChangeUserTypeSort() {
      switch (this.usertypesort) {
        case 'asc':
          this.usertypesort = 'desc'
          break
        case 'desc':
          this.usertypesort = 'asc'
          break
      }

      api
        .post(window.getSortedUserTypeUsersUrl, {
          sort: this.usertypesort,
        })
        .then(
          (response) => {
            this.users = response.data
