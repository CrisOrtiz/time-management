...
var workerHome = new Vue({
        ...
        methods: {
            updatePreferred(){
                api.post(window.updatePreferredUrl, this.user)
                .then(response => {
                    Vue.$toast.success('Horas preferidas actualizadas');
                }, error => {
            ...
            updateUserPassword(){
                ...
                .then(response => {
                    ...
                    Vue.$toast.error('Fallo! Verifica las contraseñas');
                });
            },
        },
});
